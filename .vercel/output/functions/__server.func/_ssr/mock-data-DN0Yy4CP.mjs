...
categoryUI.map((c) => ({ id: c.slug, ar: c.ar, en: c.en, icon: c.icon, color: c.color, image: c.image, sub: [] }));
const governorates = [
...
const aiInsights = [
  { period_ar: "آخر 30 يوم", period_en: "Last 30 days", trend: "up", change: "+34%", title_ar: "نمو الأزياء", title_en: "Fashion growth" },
  { period_ar: "آخر 7 أيام", period_en: "Last 7 days", trend: "up", change: "+22%", title_ar: "طلب الإلكترونيات", title_en: "Electronics demand" },
  { period_ar: "آخر 30 يوم", period_en: "Last 30 days", trend: "up", change: "+18%", title_ar: "المنزل والمطبخ", title_en: "Home & Kitchen" },
  { period_ar: "آخر 30 يوم", period_en: "Last 30 days", trend: "up", change: "-4%", title_ar: "الكتب", title_en: "Books" }
];
export {
  aiInsights as a,
  chartCategory as b,
