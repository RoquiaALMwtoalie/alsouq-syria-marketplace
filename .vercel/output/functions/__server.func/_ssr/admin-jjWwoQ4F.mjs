...
import { u as useApp } from "./router-BU7AgYzK.mjs";
...
import "./table-BsaVHwzL.mjs";
import "../_libs/radix-ui__react-scroll-area.mjs";
import "./switch-CsdoyQ0i.mjs";
import "../_libs/radix-ui__react-switch.mjs";
import "../_libs/radix-ui__react-separator.mjs";
import "./card-C7XU6h8z.mjs";
...
function AdminRoute() {
  ...
  reactExports.useEffect(() => {
    if (!app.authLoading) {
      const isAdmin2 = app.roles?.includes("admin");
      if (!app.user) {
        navigate({
          to: "/auth/$mode",
          params: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDashboard, { notificationButton: null });
}
export {
