...
function Surface(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("svg", _extends$z({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ React__default.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ React__default.createElement("g", _extends$y({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React__default.createElement("path", _extends$x({}, filteredProps, {
...
function _callSuper$l(t, o, e) {
  return o = _getPrototypeOf$l(o), _possibleConstructorReturn$l(t, _isNativeReflectConstruct$l() ? Reflect.construct(o, e || [], _getPrototypeOf$l(t).constructor) : o.apply(t, e));
}
  ...
  return _createClass$o(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement("li", _extends$w({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", _extends$v({
    className: wrapperCN,
    style: finalStyle
...
var DecimalCSS = /* @__PURE__ */ (function() {
  ...
  return _createClass$k(DecimalCSS2, [{
    key: "add",
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$u({}, filterProps(textProps, true), {
    x,
    y,
  ...
  return _createClass$j(ErrorBar2, [{
    ...
    value: function render() {
      ...
      var errorBars = data.map(function(entry) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$t({
          className: "recharts-errorBar",
          key: "bar-".concat(lineCoordinates.map(function(c) {
            return "".concat(c.x1, "-").concat(c.x2, "-").concat(c.y1, "-").concat(c.y2);
          }))
        }, svgProps), lineCoordinates.map(function(coordinates) {
          return /* @__PURE__ */ React__default.createElement("line", _extends$t({}, coordinates, {
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    var ticks = getTicksOfScale(scale, _objectSpread$t(_objectSpread$t({}, axis), {}, {
      realScaleType
    }));
    var finalAxis = _objectSpread$t(_objectSpread$t(_objectSpread$t({}, axis), ticks), {}, {
      range: range2,
      radius: outerRadius,
      realScaleType,
      scale,
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ React__default.createElement("text", _extends$s({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ React__default.createElement(Text, _extends$s({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject(label)) {
    return /* @__PURE__ */ React__default.createElement(Label, _extends$s({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React__default.createElement(Layer, {
    ...
    return /* @__PURE__ */ React__default.createElement(Label, _extends$r({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject(label)) {
    return /* @__PURE__ */ React__default.createElement(LabelList, _extends$r({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  ...
  return /* @__PURE__ */ React__default.createElement("path", _extends$q({}, filterProps(props, true), {
    className: layerClass,
    d: path,
    role: "img"
  }));
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ React__default.createElement(Animate, {
    ...
    }, /* @__PURE__ */ React__default.createElement("path", _extends$o({}, filterProps(props, true), {
      className: layerClass,
...
var _excluded$d = ["points", "className", "baseLinePoints", "connectNulls"];
function _extends$n() {
...
var Polygon = function Polygon2(props) {
  var points = props.points, className = props.className, baseLinePoints = props.baseLinePoints, connectNulls = props.connectNulls, others = _objectWithoutProperties$d(props, _excluded$d);
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ React__default.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ React__default.createElement("path", _extends$n({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ React__default.createElement("path", _extends$n({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ React__default.createElement("path", _extends$n({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ React__default.createElement("path", _extends$n({}, filterProps(others, true), {
...
var Cross = function Cross2(_ref) {
  var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$c(_ref, _excluded$c);
  ...
  return /* @__PURE__ */ React__default.createElement("path", _extends$l({}, filterProps(props, true), {
    className: clsx("recharts-cross", className),
    d: getPath2(x, y, width, height, top, left)
  }));
};
var _excluded$b = ["cx", "cy", "innerRadius", "outerRadius", "gridType", "radialLines"];
...
var PolarAngles = function PolarAngles2(props) {
  ...
  var polarAnglesProps = _objectSpread$m({
    stroke: "#ccc"
  ...
  return /* @__PURE__ */ React__default.createElement("g", {
    ...
    return /* @__PURE__ */ React__default.createElement("line", _extends$k({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle2(props) {
  ...
  var concentricCircleProps = _objectSpread$m(_objectSpread$m({
    stroke: "#ccc"
  }, filterProps(props, false)), {}, {
    fill: "none"
  });
  return /* @__PURE__ */ React__default.createElement("circle", _extends$k({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon2(props) {
  ...
  var concentricPolygonProps = _objectSpread$m(_objectSpread$m({
    stroke: "#ccc"
  }, filterProps(props, false)), {}, {
    fill: "none"
  });
  return /* @__PURE__ */ React__default.createElement("path", _extends$k({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath2(props) {
  ...
  return /* @__PURE__ */ React__default.createElement("g", {
    ...
    var key = i;
    if (gridType === "circle") return /* @__PURE__ */ React__default.createElement(ConcentricCircle, _extends$k({
      key
    }, props, {
      radius: entry,
      index: i
    }));
    return /* @__PURE__ */ React__default.createElement(ConcentricPolygon, _extends$k({
      key
    }, props, {
      radius: entry,
      index: i
...
var PolarGrid = function PolarGrid2(_ref) {
  var _ref$cx = _ref.cx, cx = _ref$cx === void 0 ? 0 : _ref$cx, _ref$cy = _ref.cy, cy = _ref$cy === void 0 ? 0 : _ref$cy, _ref$innerRadius = _ref.innerRadius, innerRadius = _ref$innerRadius === void 0 ? 0 : _ref$innerRadius, _ref$outerRadius = _ref.outerRadius, outerRadius = _ref$outerRadius === void 0 ? 0 : _ref$outerRadius, _ref$gridType = _ref.gridType, gridType = _ref$gridType === void 0 ? "polygon" : _ref$gridType, _ref$radialLines = _ref.radialLines, radialLines = _ref$radialLines === void 0 ? true : _ref$radialLines, props = _objectWithoutProperties$b(_ref, _excluded$b);
  if (outerRadius <= 0) {
    return null;
  }
  return /* @__PURE__ */ React__default.createElement("g", {
    className: "recharts-polar-grid"
  }, /* @__PURE__ */ React__default.createElement(PolarAngles, _extends$k({
    cx,
    cy,
    innerRadius,
    outerRadius,
    gridType,
    radialLines
  }, props)), /* @__PURE__ */ React__default.createElement(ConcentricPath, _extends$k({
    cx,
    cy,
    innerRadius,
    outerRadius,
...
var _excluded$a = ["cx", "cy", "angle", "ticks", "axisLine"], _excluded2$5 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$i(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties$a(_this$props3, _excluded$a);
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$a(_this$props4, _excluded2$5);
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ React__default.createElement(Text, _extends$j({}, props, {
...
_defineProperty$p(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$p(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$p(PolarRadiusAxis, "defaultProps", {
  type: "number",
  radiusAxisId: 0,
  cx: 0,
  cy: 0,
  ...
  return _createClass$h(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React__default.createElement(Dot, _extends$i({
      ...
      return /* @__PURE__ */ React__default.createElement(Polygon, _extends$i({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React__default.createElement(Layer, _extends$i({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React__default.createElement("line", _extends$i({
...
_defineProperty$o(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$o(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$o(PolarAngleAxis, "defaultProps", {
  type: "category",
  angleAxisId: 0,
  scale: "auto",
  cx: 0,
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React__default.createElement("g", null, /* @__PURE__ */ React__default.createElement("path", _extends$h({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React__default.createElement(Animate, {
    ...
    return /* @__PURE__ */ React__default.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React__default.createElement("path", _extends$h({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
var Pie = /* @__PURE__ */ (function(_PureComponent) {
  function Pie2(props) {
    ...
    _defineProperty$l(_this, "pieRef", null);
    _defineProperty$l(_this, "sectorRefs", []);
    _defineProperty$l(_this, "id", uniqueId("recharts-pie-"));
    _defineProperty$l(_this, "handleAnimationEnd", function() {
    ...
    _defineProperty$l(_this, "handleAnimationStart", function() {
  ...
  return _createClass$g(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ React__default.createElement(Shape, _extends$g({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ React__default.createElement(Curve, _extends$g({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ React__default.createElement(Text, _extends$g({}, props, {
...
_Pie = Pie;
_defineProperty$l(Pie, "displayName", "Pie");
_defineProperty$l(Pie, "defaultProps", {
  stroke: "#fff",
  fill: "#808080",
  legendType: "rect",
  cx: "50%",
...
_defineProperty$l(Pie, "parseDeltaAngle", function(startAngle, endAngle) {
  var sign = mathSign(endAngle - startAngle);
  var deltaAngle = Math.min(Math.abs(endAngle - startAngle), 360);
  return sign * deltaAngle;
});
_defineProperty$l(Pie, "getRealPieData", function(itemProps) {
...
_defineProperty$l(Pie, "parseCoordinateOfPie", function(itemProps, offset) {
...
_defineProperty$l(Pie, "getComposedData", function(_ref4) {
...
var Radar = /* @__PURE__ */ (function(_PureComponent) {
  function Radar2() {
    var _this;
    _classCallCheck$f(this, Radar2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper$d(this, Radar2, [].concat(args));
    ...
    _defineProperty$k(_this, "handleMouseEnter", function(e) {
      var onMouseEnter = _this.props.onMouseEnter;
      if (onMouseEnter) {
        onMouseEnter(_this.props, e);
      }
    });
    _defineProperty$k(_this, "handleMouseLeave", function(e) {
  ...
  _inherits$d(Radar2, _PureComponent);
  return _createClass$f(Radar2, [{
    key: "renderDots",
    ...
    value: function renderPolygonStatically(points) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(shape)) {
        radar = /* @__PURE__ */ React__default.cloneElement(shape, _objectSpread$g(_objectSpread$g({}, this.props), {}, {
          points
        }));
      } else if (isFunction(shape)) {
        radar = shape(_objectSpread$g(_objectSpread$g({}, this.props), {}, {
          points
        }));
      } else {
        radar = /* @__PURE__ */ React__default.createElement(Polygon, _extends$f({}, filterProps(this.props, true), {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React__default.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ React__default.createElement(Dot, _extends$f({}, dotProps, {
          key,
...
_defineProperty$k(Radar, "displayName", "Radar");
_defineProperty$k(Radar, "defaultProps", {
  angleAxisId: 0,
  radiusAxisId: 0,
  hide: false,
  activeDot: true,
...
_defineProperty$k(Radar, "getComposedData", function(_ref2) {
  ...
  displayedData.forEach(function(entry, i) {
    ...
    points.push(_objectSpread$g(_objectSpread$g({}, polarToCartesian(cx, cy, radius, angle)), {}, {
      name,
      value,
      cx,
      cy,
  ...
  if (isRange) {
    points.forEach(function(point2) {
      if (Array.isArray(point2.value)) {
        ...
        baseLinePoints.push(_objectSpread$g(_objectSpread$g({}, point2), {}, {
          radius
