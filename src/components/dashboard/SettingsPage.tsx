...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            {app.lang === "ar" ? "إدارة جميع إعدادات متجرك" : "Manage all your store settings"}
          </p>
        </div>
        <Button
          variant="outline"
      ...
      {/* ============================================================ */}
      <div className="bg-white dark:bg-[#1e293b] rounded-2xl border-2 border-slate-200/60 dark:border-slate-700/60 p-6 shadow-lg overflow-hidden">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold">
                {storeActive && online
                  ? (app.lang === "ar" ? "🟢 المتجر نشط" : "🟢 Store Active")
                  : (app.lang === "ar" ? "🔴 المتجر غير نشط" : "🔴 Store Inactive")}
              </h3>
              ...
              {!storeActive && storeInactiveReason && (
                <div className="mt-2 p-2 bg-amber-50/50 dark:bg-amber-950/20 rounded-lg border border-amber-200/50 dark:border-amber-800/30">
          ...
          {storeActive && online ? (
            <Button
              ...
              className="h-16 px-8 rounded-2xl bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-bold text-lg shadow-lg shadow-red-500/30 hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
            >
              <PowerOff className="h-6 w-6 mr-3" />
              {app.lang === "ar" ? "إيقاف المتجر" : "Deactivate Store"}
            </Button>
          ) : (
            <Button
              onClick={() => setShowActivateDialog(true)}
              className="h-16 px-8 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-lg shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
            >
        ...
        <DialogContent className="rounded-2xl max-w-md">
          ...
          <DialogFooter className="gap-3">
            ...
            <Button
              ...
              disabled={isLoading}
              className="rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg shadow-emerald-500/25"
            >
              {isLoading ? (
                <span className="flex items-center gap-2">
                  <div className="h-4 w-4 animate-spin rounded-full border-2 border-white/20 border-t-white" />
      ...
      <div className="bg-white dark:bg-[#1e293b] rounded-xl border border-slate-200/60 dark:border-slate-700/60 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              className="mt-1.5 rounded-xl border-slate-200/50 bg-white/50 dark:border-slate-800/50 dark:bg-slate-900/50"
            />
          </div>
          <div>
            <Label className="text-sm font-medium flex items-center gap-1">
        ...
        <div className="mt-4 space-y-2">
          <label className="flex items-center gap-2 text-sm font-medium cursor-pointer p-2 rounded-lg hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all">
            <input
              type="checkbox"
        ...
        <Button
          ...
          className="mt-5 w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-600/25 hover:shadow-xl transition-all"
        >
        ...
        <div className="grid gap-4">
          ...
          <div>
            ...
            <Textarea
              ...
              className="mt-1.5 rounded-xl border-slate-200/50 bg-white/50 dark:border-slate-800/50 dark:bg-slate-900/50 resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-200/50 dark:border-slate-800/50 pt-4">
            ...
            <div>
              ...
              <ImageInput
                ...
                previewClassName="h-32 rounded-2xl"
              />
            </div>
          </div>
          ...
          <div className="border-t border-slate-200/50 dark:border-slate-800/50 pt-4">
            ...
            <div className="mb-3">
              ...
              >
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                  <RadioGroupItem value="online" id="settings-store-online" />
                  <Label htmlFor="settings-store-online" className="cursor-pointer text-sm">
                    <Globe className="inline h-4 w-4 mr-1" />
                    {app.lang === "ar" ? "اونلاين" : "Online"}
                  </Label>
                </div>
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                  <RadioGroupItem value="physical" id="settings-store-physical" />
                  <Label htmlFor="settings-store-physical" className="cursor-pointer text-sm">
            ...
            <div className="mb-3">
              ...
              <Select value={governorateId} onValueChange={setGovernorateId}>
                <SelectTrigger className="mt-1.5 rounded-xl border-slate-200/50 bg-white/50 dark:border-slate-800/50 dark:bg-slate-900/50">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 p-3 mt-1.5 rounded-xl border border-slate-200/50 dark:border-slate-800/50 bg-white/50 dark:bg-slate-900/50">
                {WEEK_DAYS.map((day) => (
                  <label key={day.value} className="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-lg hover:bg-blue-500/5 transition-all">
                    <input
                      type="checkbox"
          ...
          <Button
            ...
            disabled={isLoading}
            className="mt-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-600/25 hover:shadow-xl transition-all w-full"
          >
            {isLoading ? (
              <span className="flex items-center gap-2">
                <div className="h-4 w-4 animate-spin rounded-full border-2 border-white/20 border-t-white" />
