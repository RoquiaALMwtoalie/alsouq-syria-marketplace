          ...
          <div className="mt-6 max-w-md">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-white/10 backdrop-blur border-white/20 text-white placeholder:text-white/60 rounded-xl focus:bg-white/20 focus:border-white/40 transition"
              />
            </div>
          </div>
        </div>
          ...
          <>
            ...
            {!searchQuery && featuredCategories.length > 0 && (
              <div className="mb-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {featuredCategories.slice(0, 6).map((cat: any) => {
                    ...
                    return (
                      <Link
                        ...
                        className="group relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 border-2 border-yellow-400/30 hover:border-yellow-400/60 text-center overflow-hidden"
                      >
                        ...
                        <div className="relative">
                          ...
                          <div className="h-16 w-16 rounded-full overflow-hidden bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-yellow-900/30 dark:to-yellow-800/30 flex items-center justify-center mx-auto group-hover:scale-110 transition-transform border-2 border-yellow-300/30">
                            {hasImage ? (
                              <img 
                                src={cat.image_url} 
                                ...
                                onError={(e) => {
                                  ...
                                  // ✅ إذا فشل تحميل الصورة، عرض الأيقونة
                          ...
                          <p className="mt-3 font-semibold text-sm text-slate-900 dark:text-white group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition">
                          ...
                          <Badge className="absolute -top-2 -right-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white border-0 text-[9px] px-1.5 py-0.5 shadow-lg">
                      ...
                      >
                        {isFeatured && (
                          <div className="absolute -top-2 -right-2">
                            <Badge className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white border-0 text-[8px] px-1.5 py-0.5 shadow-lg">
                              ⭐ {app.lang === "ar" ? "مميز" : "Featured"}
                            </Badge>
                          </div>
                        )}
