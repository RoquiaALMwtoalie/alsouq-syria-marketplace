// src/routes/distributor/conversation.$userId.tsx
...
import { 
  Loader2, MoreVertical, User, Building2, Truck, Crown, Store, ChevronRight
} from "lucide-react";
...
export const Route = createFileRoute("/distributor/conversation/$userId")({
  ...
  head: () => ({ meta: [{ title: "المحادثة — الموزع" }] }),
});
...
function DistributorConversationPage() {
  ...
  const handleBack = () => {
    navigate({ to: "/distributor/messages" });
  };
