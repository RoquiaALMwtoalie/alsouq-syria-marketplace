// src/routes/orders.tsx - الكود الكامل مع فورم التقييم
...
function OrdersPage() {
  ...
  const [orderReviewDialogOpen, setOrderReviewDialogOpen] = useState(false);
  ...
  // ============================================================
  // ✅ useEffect: فتح فورم التقييم تلقائياً لو الرابط فيه ?review=
  // ============================================================
  useEffect(() => {
    if (search?.review && groupedOrders.length > 0) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-[#e8f0ee] dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-8">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-3">
              <div className="p-2 rounded-2xl bg-gradient-to-br from-[#2a655f] to-[#1a4f4a] text-white shadow-lg shadow-[#2a655f]/30">
          ...
          <Link to="/">
            <Button variant="outline" className="rounded-xl border-2 border-[#2a655f]/30 hover:border-[#2a655f]/60 hover:bg-[#2a655f]/10 text-[#2a655f] font-bold transition-all duration-300">
        ...
        {groupedOrders.length === 0 ? (
          <div className="text-center py-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-3xl border-2 border-dashed border-[#2a655f]/30">
            <div className="text-7xl mb-4">📦</div>
            <h3 className="text-2xl font-semibold text-[#2a655f]">
            ...
            <Link to="/products">
              <Button className="mt-6 bg-gradient-to-r from-[#2a655f] to-[#1a4f4a] hover:from-[#1a4f4a] hover:to-[#2a655f] text-white rounded-xl shadow-lg shadow-[#2a655f]/30 transition-all duration-300 hover:scale-105 font-bold">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    "border-3",
                    isActive
                      ? "border-[#2a655f]/40 dark:border-[#3a8a82]/50 shadow-[#2a655f]/15 hover:shadow-[#2a655f]/30"
                      : "border-[#2a655f]/20 dark:border-[#2a655f]/30 hover:shadow-md"
                  )}
                >
                  {/* ===== ORDER HEADER - OLIVE & SLATE ===== */}
                  <div
                    className={cn(
                      "p-5 cursor-pointer transition-all duration-300",
                      isActive
                        ? "bg-gradient-to-r from-[#2a655f]/5 via-[#3a8a82]/10 to-[#1a4f4a]/5 dark:from-[#2a655f]/10 dark:via-[#3a8a82]/5 dark:to-[#1a4f4a]/10 hover:from-[#2a655f]/10 hover:via-[#3a8a82]/20 hover:to-[#1a4f4a]/10"
                        : "hover:bg-[#2a655f]/5 dark:hover:bg-[#2a655f]/10"
                    )}
                    onClick={() => setExpandedOrder(isExpanded ? null : group.orderId)}
                  >
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div className="flex items-center gap-4">
                        <div className="relative h-14 w-14 rounded-2xl overflow-hidden flex-shrink-0 border-3 border-[#2a655f]/30 dark:border-[#2a655f]/40 shadow-lg hover:shadow-xl transition-all duration-300">
                          {group.storeLogo ? (
                            <OptimizedImage
                              src={group.storeLogo}
                              alt={group.storeName}
                            ...
                            <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-[#2a655f]/20 to-[#1a4f4a]/20 text-[#2a655f] font-bold text-xl">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {isExpanded ? (
                          <ChevronUp className="h-5 w-5 text-[#2a655f] transition-transform duration-300" />
                        ) : (
                          <ChevronDown className="h-5 w-5 text-[#2a655f] transition-transform duration-300" />
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  {/* ===== DETAILS (EXPANDED) ===== */}
                  {isExpanded && (
                    <div className="px-5 pb-5 pt-3 border-t-3 border-[#2a655f]/20 dark:border-[#2a655f]/30 animate-fade-up">
                      <div className="space-y-4">
                        <div className={cn(
                              ...
                              <div
                                ...
                                className={cn(
                                  ...
                                  isPromo
                                    ...
                                    : "bg-slate-50/80 dark:bg-slate-800/40 border-[#2a655f]/20 dark:border-[#2a655f]/30 hover:border-[#2a655f]/50"
                                )}
                              >
                                {isPromo ? (
                                  <div className="space-y-3">
                                        ...
                                        {Object.entries(requiredVariations).map(([id, data]: any) => {
                                          ...
                                          return (
                                            <div key={id} className="flex items-center gap-3 p-2 bg-white/70 rounded-xl border border-purple-100/50">
                                              ...
                                              <p className="text-sm font-bold text-[#2a655f] whitespace-nowrap">
                                  ...
                                  <div className="flex items-center gap-4">
                                    <div className="h-12 w-12 rounded-xl overflow-hidden flex-shrink-0 border-2 border-[#2a655f]/20 dark:border-[#2a655f]/30">
                                      {imageUrl ? (
                                        <OptimizedImage
                                          src={imageUrl}
                                          alt=""
                                      ...
                                      <div className="flex items-center gap-3 text-xs text-muted-foreground flex-wrap">
                                        ...
                                        {item.selected_variation_id && (
                                          <span className="text-[9px] text-muted-foreground/70 flex items-center gap-1">
                                            <Layers className="h-2.5 w-2.5 text-[#2a655f]" />
                                    ...
                                    <Link to="/listing/$id" params={{ id: item.listing_id || item.id }}>
                                      <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-lg hover:bg-[#2a655f]/10 border border-[#2a655f]/20 hover:border-[#2a655f]/50">
                        ...
                        {canRateThisOrder && (
                          <Button
                            variant="outline"
                            size="sm"
                            className="w-full rounded-xl border-2 border-[#2a655f]/30 text-[#2a655f] hover:bg-[#2a655f]/10 hover:border-[#2a655f] transition-all duration-300 group font-bold"
                            onClick={() => {
                              setOrderToReview(group);
                              setOrderReviewDialogOpen(true);
                            }}
                          >
                            <Star className="h-4 w-4 mr-2 group-hover:scale-110 transition-transform fill-yellow-400 text-yellow-400" />
                            {app.lang === "ar" ? "⭐ قيّم الطلب الآن" : "⭐ Rate this order now"}
                          </Button>
                        )}

                        {/* ✅ زر إلغاء الطلب كامل - OLIVE & SLATE */}
                        {canCancelOrder && (
                          <Button
                            variant="destructive"
                            size="sm"
                        ...
                        <div className="p-4 bg-gradient-to-r from-[#2a655f]/5 to-[#1a4f4a]/5 dark:from-[#2a655f]/10 dark:to-[#1a4f4a]/10 rounded-xl border-2 border-[#2a655f]/20 dark:border-[#2a655f]/30">
                          <div className="flex items-center justify-between">
      ...
      {/* ===== COMPLAINT DIALOG - OLIVE & SLATE ===== */}
      <Dialog open={complaintDialogOpen} onOpenChange={setComplaintDialogOpen}>
        <DialogContent className="max-w-lg rounded-2xl border-2 border-[#2a655f]/30 shadow-2xl shadow-[#2a655f]/10 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm">
          <DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label className="text-[#2a655f] font-bold">
              ...
              <Input
                ...
                className="rounded-xl border-2 border-[#2a655f]/30 focus:border-[#2a655f] focus:ring-[#2a655f]/20 font-medium"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[120px] rounded-xl border-2 border-[#2a655f]/30 focus:border-[#2a655f] focus:ring-[#2a655f]/20 font-medium"
              />
          ...
          <DialogFooter className="gap-2">
            <Button
              ...
              className="rounded-xl border-2 border-[#2a655f]/30 hover:bg-[#2a655f]/10 font-bold"
            >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#2a655f] to-[#1a4f4a] hover:from-[#1a4f4a] hover:to-[#2a655f] text-white rounded-xl shadow-lg shadow-[#2a655f]/30 transition-all duration-300 hover:scale-[1.02] font-bold border-0"
            >
      ...
      {/* ===== DIALOG: تأكيد إلغاء الطلب (احترافي) - OLIVE & SLATE ===== */}
      <Dialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
        <DialogContent className="max-w-md rounded-2xl border-2 border-red-200/50 dark:border-red-800/30 bg-white dark:bg-slate-900 p-0 shadow-2xl shadow-red-500/10 overflow-hidden">
          ...
          <DialogFooter className="p-4 border-t-2 border-slate-200/50 dark:border-slate-800/50 bg-gradient-to-r from-[#2a655f]/5 to-[#1a4f4a]/5 dark:from-[#2a655f]/10 dark:to-[#1a4f4a]/10 gap-3">
            <Button
              variant="outline"
              onClick={() => {
                setCancelDialogOpen(false);
              ...
              className="flex-1 rounded-xl border-2 border-[#2a655f]/30 hover:bg-[#2a655f]/10 transition-all duration-300 font-bold"
