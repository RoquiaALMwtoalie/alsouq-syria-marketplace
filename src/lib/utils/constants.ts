...
export const SINGULAR_MAP: Record<string, string> = {
  ...
  'weights': 'weight',
  'weight_kg': 'weight',     // ✅ جديد - الوزن (كغم)
  'weight': 'weight',        // ✅ جديد - وزن
...
export const ALLOWED_OPTION_TYPES = [
  ...
  'gender', 'brand', 'storage', 'ram', 'processor', 'battery',
  'screen_size', 'camera', 'connectivity', 'bluetooth', 'dimension',
  'weight_kg', 'material_type', 'shoe_size', 'shoe_type', 'watch_band',
  'occasion', 'age_group', 'type', 'category', 'group', 'level',
  'grade', 'class', 'rank', 'status', 'location', 'region',
  'city', 'country', 'month', 'year', 'day', 'time',
